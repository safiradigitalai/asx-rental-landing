...
export default function TestimonialsSection() {
  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      testimonial: "Viagem com toda família estendida - 8 pessoas! O Suburban comportou perfeitamente nosso grupo. Cadeirinhas gratuitas para as crianças foi um alívio no orçamento. Serviço impecável do início ao fim.",
